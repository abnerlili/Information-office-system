...
<head>
    ...
    <script language="javascript" type="text/javascript">
		...
		function check(form)
		{
			...
			if(document.addact.name.value.trim()==""   || document.addact.place.value.trim()=="" || document.addact.comment.value.trim()=="")
			{
				alert("任何空不能为空！")
				return false;
			}
...
<body>
	<form  name ="addact" method="post" action="addactivity.php" onsubmit="javascript:return check();">
	<table width="300" height="96" border="0" align="center" cellpadding="0" cellspacing="1">
        <caption>活动申报</caption>
		<tr><td>活动名称：<input type="text" name="name" size="30"></td></tr>
    	<tr><td>活动地点：<input type="text" name="place"  size="30"></td></tr>
    </table>
    <table width="300" height="96" border="0" align="center" cellpadding="0" cellspacing="1">
    	<tr>
            <td>开始时间：</td>
